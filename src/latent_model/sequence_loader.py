...
class SequenceLoader():
    ...
    def _split_data(self) -> tuple[list[int], ...]:
        ...
        train_ids, test_ids = train_test_split(sample_ids, test_size=self.test_split, random_state=self.random_seed)
        train_ids, val_ids = train_test_split(train_ids, test_size=self.val_split, random_state=self.random_seed)
