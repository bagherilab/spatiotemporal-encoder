...
class CellMetrics:
    ...
    Cell state mappings (ARCADE < v3.0):
    0: neutral (undecided)
    1: apoptotic
    2: quiescent
    3: migrating
    ...
    num_cells: int
    avg_volume: float
    percent_undecided: float
    percent_apoptotic: float
    percent_quiescent: float
    percent_migrating: float
    percent_proliferating: float
    percent_senescent: float
